...
type APIDefinitionParams struct {
	...
	UploadSource string `json:"upload_source,omitzero" validate:"required_without=Url Schema"`
	Url          string `json:"url,omitzero" validate:"required_without=Schema UploadSource"`
}
